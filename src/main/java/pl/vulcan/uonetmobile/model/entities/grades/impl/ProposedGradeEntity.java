...
@DatabaseTable(tableName = "ProposedGrades")
public class ProposedGradeEntity extends SummaryGradeEntity {
	...
	public boolean equals(Object obj) {
		...
		ProposedGradeEntity proposedGradeEntity = (ProposedGradeEntity) obj;
		return this.c != proposedGradeEntity.c ? false
				: this.e != null ? this.e.equals(proposedGradeEntity.e) : proposedGradeEntity.e == null;
	}
	...
	public String toString() {
		...
		stringBuilder.append("ProposedGradeEntity{mSubjectId=");
